        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="p-5 bg-neutral-900 border border-neutral-800 rounded-xl">
            <div className="flex justify-between items-baseline mb-3">
              <span className="text-sm text-neutral-400">Current Probability</span>
          ...
          {/* Supporting Evidence */}
          <section>
            <h2 className="text-lg font-semibold text-white mb-2">Supporting Evidence</h2>
              ...
              {mockSupportingModules.map((mod) => (
                ...
                >
                  ...
                  <div className="flex gap-6 text-sm mb-3">
                    <div>
                      <span className="text-neutral-500">Module Prob.</span>
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between">
                <span className="text-neutral-400">Evidence Modules</span>
