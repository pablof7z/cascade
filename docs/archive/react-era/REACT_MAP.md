...
- Migration notes in `docs/archive/react-era/react-removal-audit.md`

Detailed per-route notes and page microcopy now live under [`react_map/`](react_map/index.md), with one markdown file per route.
...
| Path | Kind | Component | Details |
|---|---|---|---|
| `/portfolio` | page | `Portfolio` | User positions, PnL, withdrawal flow, and withdrawal history. |
