      ...
      <section className="mb-8">
        ...
        <div className="flex gap-1 mb-4">
          {typeFilters.map((filter) => (
            ...
            >
              {filter}
              {filter === 'Modules' && (
                <span className="ml-1 text-neutral-500">({moduleCount})</span>
              )}
              {filter === 'Theses' && (
                <span className="ml-1 text-neutral-500">({thesisCount})</span>
              )}
            </button>
          ))}
        </div>
        ...
        <div className="flex flex-wrap gap-8 py-4 border-y border-neutral-800">
          ...
          <div>
            ...
            <div className="text-xs uppercase tracking-wider text-neutral-500">Avg. resolution horizon</div>
          </div>
        </div>
