  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-6">
      <nav className="mb-6">
        ...
        <span className="text-neutral-500 text-sm ml-2">New Thesis</span>
      </nav>
                ...
                {filteredModules.map((mod) => (
                  ...
                  >
                    ...
                    {isSelected(mod.id) ? (
                      ...
                      <button type="button" className="text-neutral-400 hover:text-white ml-2 text-xl">
                        +
                      </button>
                    )}
                  </div>
          ...
          <div className="space-y-6">
            <div className="space-y-4">
              <label className="block">
                <span className="text-sm font-medium text-neutral-300 mb-1 block">Thesis Title</span>
                <input
                  type="text"
                  value={thesisTitle}
              ...
              <label className="block">
                <span className="text-sm font-medium text-neutral-300 mb-1 block">Description</span>
                <textarea
                  ...
                  rows={3}
                  className="w-full px-4 py-3 bg-neutral-800 border border-neutral-700 rounded-lg text-white placeholder-neutral-500 focus:outline-none focus:border-neutral-500 resize-none"
                />
              </label>
            </div>
            ...
            <div>
              ...
              {selectedModules.length === 0 ? (
                <div className="p-6 bg-neutral-800/50 border border-dashed border-neutral-700 rounded-lg text-center">
                  <p className="text-neutral-500 text-sm">Select modules from the left to use as evidence</p>
                </div>
              ) : (
                <div className="space-y-3">
                  {selectedModules.map((mod) => (
                    <div key={mod.id} className="p-4 bg-neutral-800 border border-neutral-700 rounded-lg">
            ...
            <button
              type="button"
              className="w-full py-3 bg-white hover:bg-neutral-100 disabled:bg-neutral-700 disabled:text-neutral-500 text-neutral-900 font-semibold rounded-lg transition-colors"
